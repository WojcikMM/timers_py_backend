...
if __name__ == '__main__':
    connect(environ['MONGO_DATABASE_NAME'], host=environ['MONGO_DATABASE_SERVER'], port=environ['MONGO_DATABASE_PORT'])
    app.run(port=environ['FLASK_DEFAULT_PORT'], debug=app_is_debug_mode, use_reloader=app_use_reloader, threaded=False)
